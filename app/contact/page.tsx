          ...
          <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              >
                <Card className="p-8 md:p-10 border border-border">
                  <form onSubmit={handleSubmit} className="space-y-6">
                    {success && (
                      <div className="p-4 bg-accent/10 text-accent rounded-lg text-sm font-medium flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        required
                        className="w-full px-4 py-3 rounded-lg border border-border bg-background text-foreground focus:border-accent focus:ring-2 focus:ring-accent/20 outline-none transition-colors"
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        required
                        rows={6}
                        className="w-full px-4 py-3 rounded-lg border border-border bg-background text-foreground focus:border-accent focus:ring-2 focus:ring-accent/20 outline-none transition-colors resize-none"
              ...
              <motion.div
                ...
                transition={{ duration: 0.6 }}
              >
                <Card className="p-6 border border-border hover:shadow-lg hover:shadow-accent/20 transition-all">
                ...
                <Card className="p-6 border border-border hover:shadow-lg hover:shadow-accent/20 transition-all">
                  <div className="flex gap-4">
                    <MessageSquare className="h-6 w-6 text-accent flex-shrink-0 mt-0.5" />
                    <div>
                  ...
                  <div className="flex gap-3">
                    {[
                      ...
                      <a
                        key={social.label}
                        href={social.href}
                        className="p-3 rounded-lg bg-accent/10 border border-accent hover:bg-accent hover:text-accent-foreground transition-all"
